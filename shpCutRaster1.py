...
# 用于裁剪的栅格数据
raster = r'E:\ArcGISdata\lls\data\3unit\3.2\tsR1.tif'
# 用于裁剪的多边形shp
shp = r'E:\ArcGISdata\lls\data\3unit\3.2\tsB'
# 裁剪后的栅格数据
output = r'D:\clip'
...
# 根据掩膜图层对图像进行裁剪
clip1 = (clip, 0)
clip2 = gdal_array.numpy.choose(mask, clip1)
clip = clip2.astype(gdal_array.numpy.uint16)
print(clip.max())
# 将NDVI保存为tiff文件
